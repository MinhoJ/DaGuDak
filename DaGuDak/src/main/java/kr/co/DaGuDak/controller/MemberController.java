...
import kr.co.DaGuDak.dao.MemberDAOImpl;
...
public class MemberController {
	...
	public String updateMember(@ModelAttribute MemberVO vo) throws Exception {
		service.updateMember(vo);
		ModelAndView mv = new ModelAndView();
		mv.addObject("updatePassword", vo.getPassword());

		return "member/myPage"; // ?
	}

	@RequestMapping(value = "myPageUpdate", method = RequestMethod.GET)
	public String myPageUpdate(Locale locale, Model model) {
	...
	public ModelAndView chargePointPost(Model model,HttpSession session, @ModelAttribute MemberVO vo) throws Exception {
		ModelAndView mv = new ModelAndView();
		String loginId = (String) session.getAttribute("userId");
