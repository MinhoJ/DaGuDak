    ...
    IMP.request_pay({ // param
        ...
        if (rsp.success) {
          ...
          jQuery.ajax({
               ...
               var msg = point + "포인트가 충전되었습니다.";
            })
        } else {
            var msg = "충전에 실패하였습니다. " + rsp.error_msg;
        }
       alert(msg);
      });
  }
...
<section class="ftco-section contact-section ftco-no-pb"
   ...
   <div class="container">
      ...
      <div class="row block-9"
         ...
         <div>
            <form name="charge" action="${pageContext.request.contextPath}/member/pointBank"
               method="post" class="p-4 p-md-5 contact-form">
               <div class="row">
                  ...
                  <div
                     ...
                     <div class="form-group">
                        <input type="button" onclick="requestPay()" id="btnChargePoint" name="btnChargePoint" value="충전하기"
