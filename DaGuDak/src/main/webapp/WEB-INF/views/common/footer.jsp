         ...
         <div class="col-lg col-md-6">
            <div class="ftco-footer-widget">
               ...
               <ul class="list-unstyled">
                  ...
                  <li><a href="${pageContext.request.contextPath}/race/racing"><span
            ...
            <div class="ftco-footer-widget">
               ...
               <div class="block-23 mb-3">
                  <ul>
                     ...
                     <li><a href="${pageContext.request.contextPath}/csChat"><span
                           class="fa fa-chevron-right mr-2"></span>1:1 문의하기</a></li>
                     ...
                     <li><a href="#"><span class="fa fa-paper-plane mr-3"></span><span
                           class="text">info@dagudak.com</span></a></li>
                  </ul>
               </div>
            </div>
         </div>
