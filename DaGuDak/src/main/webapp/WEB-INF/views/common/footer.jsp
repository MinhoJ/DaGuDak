           ...
           <!--  <div class="col-lg-4 col-md-6">
               <div class="ftco-footer-widget">
                  ...
                  <div class="d-flex">
                     <ul class="list-unstyled mr-md-4">
                        ...
                        <li><a href="#"><span class="fa fa-chevron-right mr-2"></span>익명게시판</a></li>
                        <li><a href="#"><span class="fa fa-chevron-right mr-2"></span>관련 뉴스</a></li>
                     </ul>
                     <ul class="list-unstyled ml-md-5">
                        <li><a href="#"><span class="fa fa-chevron-right mr-2"></span>기타</a></li>
                        <li><a href="#"><span class="fa fa-chevron-right mr-2"></span>기타의 기타</a></li>
                     </ul> 
                  </div>
               </div>
            </div> -->
            ...
            <div class="col-lg col-md-6">
               <div class="ftco-footer-widget">
                  ...
                  <ul class="list-unstyled">
                    <li><a href="/DaGuDak/notice"><span class="fa fa-chevron-right mr-2"></span>공지사항</a></li>
                        <li><a href="/DaGuDak/forum"><span class="fa fa-chevron-right mr-2"></span>익명게시판</a></li>
            ...
            <div class="col-lg col-md-6">
               <div class="ftco-footer-widget">
                  ...
                  <ul class="list-unstyled">
                     <li><a href="/DaGuDak/racingList"><span class="fa fa-chevron-right mr-2"></span>오늘의 경기</a></li>
                     <li><a href="/DaGuDak/racing"><span class="fa fa-chevron-right mr-2"></span>경기 바로가기</a></li>
                     <li><a href="/DaGuDak/horses"><span class="fa fa-chevron-right mr-2"></span>경주마 정보</a></li>
                  </ul>
               </div>
            </div>
            ...
            <div class="col-lg col-md-6">
               <div class="ftco-footer-widget">
                  ...
                  <div class="block-23 mb-3">
                     <ul>
                        <li><a href="/DaGuDak/customerService"><span class="fa fa-chevron-right mr-2"></span>FAQ</a></li>
                        <li><a href="/DaGuDak/csChat"><span class="fa fa-chevron-right mr-2"></span>1:1 문의하기</a></li>
                        <li><a href="#"><span class="fa fa-phone mr-3"></span><span class="text">02) 1234 5678</span></a></li>
                        <li><a href="#"><span class="fa fa-paper-plane mr-3"></span><span class="text">info@dagudak.com</span></a></li>
                     </ul>
                  </div>
               </div>
            </div>
